    ...
    <div className='Productpage-container'>
        ...
        <div className='img-container'>
            ...
            <div className='bg-left'>
                <span className='rr1'>I'm lovin' it!</span><br/>
                <span className='rr2'>{resName}</span>
                <div className='bg-mid'>
                    <button className='note'>Minimum Order: 12 GBP</button>
                    <button className='note'>Delivery in 20-25 Minutes</button>
            </div>
            ...
            <div className='bg-right'>
                 ...
                 <img src='burr.png' className='burr'/>
            </div>
            <img src='rat.png' className='rat'/>


        </div>   
        <button className='dis'><img src='clo.png'/>Open until 3:00 AM</button>      
